...
def test_empty_local_design_context_does_not_fallback_to_erp(monkeypatch):
    monkeypatch.setattr(
        'domain_packs.mold.tool_gateway.erp_design_mcp.execute_tool',
