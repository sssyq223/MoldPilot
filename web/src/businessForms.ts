...
export const stateLabels:Record<string,string>={DRAFT:'草稿',SUBMITTED:'审批中',APPROVED:'审批通过',APPLY_BLOCKED:'审批通过 · 待业务生效',EFFECTIVE:'已生效',REJECTED:'已驳回',RETURNED:'退回修改',CANCELLED:'已取消',CLOSED:'已关闭',ISSUED:'已正式下单',PLANNED:'计划中',RUNNING:'执行中',DONE:'已完成',STOPPED:'已停止',PAUSED:'已暂停',TERMINATED:'已终止',OPEN:'办理中',NOT_APPLICABLE:'不适用'}
