...
const contextPopoverOpen=ref(false),modelPopoverOpen=ref(false)
...
function escapeMenu(e:KeyboardEvent){if(e.key==='Escape'){if(showProfile.value)closeProfile();contextPopoverOpen.value=false;modelPopoverOpen.value=false}}
