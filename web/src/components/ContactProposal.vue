...
const base=props.proposal.kind==='project_control'?'/project-control-proposals/':props.proposal.kind==='project_closure'?'/project-closure-proposals/':'/contact-proposals/'
const approval=props.proposal.kind==='project_control'||props.proposal.requires_approval
