...
const base=props.proposal.kind==='project_control'?'/project-control-proposals/':props.proposal.kind==='project_closure'?'/project-closure-proposals/':props.proposal.kind==='project_plan_change'?'/project-plan-proposals/':'/contact-proposals/'
