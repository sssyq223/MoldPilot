...
export const capabilityNames:Record<string,string>={query_projects:'查询项目资料',query_purchase_requests:'查询采购申请',purchase_review:'采购资料核对',project_overview:'项目概况查询',query_orders:'查询采购订单',query_business_subjects:'查询业务材料',query_business_object_candidates:'查询业务对象候选',query_quote_acceptance_context:'读取报价承接上下文',query_contract_context:'读取合同上下文',query_internal_start_readiness:'核对正式开工条件',analyze_delivery_risk:'分析发货延期风险'}
Object.assign(capabilityNames,{purchase_request_review:'采购申请核对',business_object_matching:'业务对象候选匹配',quote_acceptance_review:'报价与承接上下文核对',contract_context_review:'合同上下文核对',internal_start_readiness:'正式开工条件核对',delivery_risk_analysis:'供应商发货风险分析',business_status_review:'业务审批与执行核对',query_purchase_orders:'查询采购订单'})
