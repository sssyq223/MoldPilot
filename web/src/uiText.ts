...
Object.assign(capabilityNames,{purchase_request_review:'采购申请核对',business_object_matching:'业务对象候选匹配',quote_acceptance_review:'报价与承接上下文核对',quote_evaluation_review:'报价评估与加工方式核对',bid_intake_review:'中标接收与客户规则核对',contract_context_review:'合同上下文核对',internal_start_readiness:'正式开工条件核对',project_plan_context_review:'项目计划上下文核对',design_route_context_review:'设计BOM与路线上下文核对',procurement_price_context_review:'采购价格与订单上下文核对',delivery_risk_analysis:'供应商发货风险分析',business_status_review:'业务审批与执行核对',query_purchase_orders:'查询采购订单'})
