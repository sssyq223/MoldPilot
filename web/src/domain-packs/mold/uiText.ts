...
Object.assign(auditNames,{"file.uploaded":"上传会话附件","file.downloaded":"下载附件原件","file.previewed":"查看附件图片","contact.attachment_added":"关联联络单附件版本","contract.attachment_linked":"关联合同附件版本"})
