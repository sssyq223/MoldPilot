...
Object.assign(capabilityNames,{prepare_contact_attach:"准备关联联络单附件"})

Object.assign(verbs,{attach:"关联附件",upload:"上传本人会话附件"})
Object.assign(auditNames,{"file.uploaded":"上传会话附件","file.downloaded":"下载附件原件","file.previewed":"在线预览附件","contact.attachment_added":"关联联络单附件版本","contract.attachment_linked":"关联合同附件版本","document.intake.created":"创建文档接收批次","document.type.confirmed":"确认文档类型","document.ocr.completed":"完成文档识别","document.ocr.failed":"文档识别失败","contract.intake.reviewed":"复核合同识别结果","contract.document.linked":"关联合同原件","contract.relationship.confirmed":"确认合同版本关系"})
...
Object.assign(capabilityNames,{query_confirmed_bid_notices:'读取已确认中标事件',prepare_bid_notice_match:'准备登记中标匹配记录',prepare_bid_project_match:'准备人工匹配中标项目',prepare_bid_intake_confirmation:'准备确认中标接收版本',prepare_start_notice:'准备开工通知草稿',prepare_department_ack:'准备部门回执',prepare_project_start_decision:'准备项目部开工决定',prepare_post_start_binding:'准备合同/清单后置绑定',bid_to_start_notice:'中标到开工通知及后置关联'})
...
Object.assign(capabilityDepartments,{query_confirmed_bid_notices:'sales',prepare_bid_notice_match:'sales',prepare_bid_project_match:'sales',prepare_bid_intake_confirmation:'sales',prepare_start_notice:'project',prepare_department_ack:'project',prepare_project_start_decision:'project',prepare_post_start_binding:'finance',bid_to_start_notice:'sales'})
Object.assign(capabilityTypes,{project_kickoff_orchestration:'review'})
Object.assign(capabilityTypes,{prepare_bid_notice_match:'operation',prepare_bid_project_match:'approval',prepare_bid_intake_confirmation:'operation',prepare_start_notice:'approval',prepare_department_ack:'operation',prepare_project_start_decision:'approval',prepare_post_start_binding:'operation',bid_to_start_notice:'review'})
