...
from .schemas import StrictModel, SubmitInput
from .security import current_user
from .db import get_db
from . import models as m, domains, domain_schemas as s, procurement, business
from .authorization import require, predicate
...
def install(app):
    ...
    def reference_options(kind:str,project_id:str,category:str|None=None,user=Depends(current_user),db=Depends(get_db)):
        ...
        from .authorization import access
    ...
    def commands(user=Depends(current_user)):
        from .domain_commands import COMMANDS
