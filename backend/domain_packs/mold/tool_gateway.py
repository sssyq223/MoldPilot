...
TOOLS.update({
    ...
    'prepare_contract_record':{'description':'使用本轮明确上传的 PDF、图片或 DOCX 原件，准备销售合同或整套委外合同登记审批建议；必须使用真实项目、项目版本、附件 ID 和流程 ID，本人确认后才冻结附件并提交 Agent BPM。','permission':'project.dossier.read'},
